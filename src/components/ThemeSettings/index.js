...
const ThemeSettings = () => {
  ...
  const curThemeName = localStorage.getItem('appTheme') || 'LightTheme1';
        ...
        >
          ...
          <ThemeToggleWrapper>
            ...
            <Stack alignItems="center" spacing={2}>
              <Tooltip placement="left" title="Light 1" arrow>
                <ButtonWrapper
                  className={theme === 'LightTheme1' ? 'active' : ''}
                  onClick={() => {
                    changeTheme('LightTheme1');
                  }}
                >
                  {theme === 'LightTheme1' && (
                    <CheckSelected>
                  ...
                  <ColorSchemeWrapper className="colorSchemeWrapper Light1">
                    <Box className="primary" />
                  </ColorSchemeWrapper>
                </ButtonWrapper>
              </Tooltip>

              <Tooltip placement="left" title="Dark Theme" arrow>
                <ButtonWrapper
                  className={theme === 'DarkTheme' ? 'active' : ''}
                  onClick={() => {
                ...
                >
                  ...
                  <ColorSchemeWrapper className="colorSchemeWrapper darkTheme">
                    <Box className="primary" />
