...
const themeColors = {
  ...
  white: '#ffffff',
  menuItem: '#CBD2D9',
  bgcolor: 'linear-gradient(135deg, #05153f 28%, #072561 90%)'
};
...
const colors = {
  ...
  layout: {
    ...
    sidebar: {
      ...
      dividerBg: darken(themeColors.secondary, 0.3),
      menuItemColor: themeColors.white,
      menuItemColorActive: themeColors.white,
      menuItemBg: themeColors.primaryAlt,
      menuItemBgActive: lighten(themeColors.primary, 0.0),
      menuItemIconColor: themeColors.menuItem,
      menuItemIconColorActive: themeColors.menuItem,
      menuItemHeadingColor: darken(themeColors.menuItem, 0.2)
    }
  },
  alpha: {
    white: {
...
export const DarkTheme = createTheme({
  ...
  header: {
    height: '80px',
    background: colors.alpha.primaryAlt[100],
  ...
  palette: {
    ...
    background: {
      paper: colors.alpha.primaryAlt[100],
      default: colors.layout.general.bodyBg
    },
    action: {
      active: colors.alpha.black[100],
      hover: colors.primary.darker,
      hoverOpacity: 0.1,
        ...
        list: {
          ...
          '& .MuiMenuItem-root.MuiButtonBase-root': {
            ...
            '&:hover, &:active, &.active, &.Mui-selected': {
              color: colors.alpha.black[100],
              background: alpha(colors.primary.lighter, 0.6)
            }
          }
        }
      }
